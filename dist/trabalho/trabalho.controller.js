...
let TrabalhoController = class TrabalhoController {
    ...
    async Retornotrabalho() {
        ...
        const listaRetorno = trabalhoListados.map((trabalho) => new lista_trabalho_dto_1.ListaTrabalhoDTO(trabalho.id, trabalho.trabalho, trabalho.preRequisitos, trabalho.siteEmpresa, trabalho.cidadeEstado, trabalho.nome));
        return listaRetorno;
    }
    ...
    async criaTrabalho(dadosTrabalho) {
        var trabalho = new trabalho_entity_1.TrabalhoEntity((0, uuid_1.v4)(), dadosTrabalho.tipos, dadosTrabalho.nome, dadosTrabalho.trabalho, dadosTrabalho.preRequisitos, dadosTrabalho.siteEmpresa, dadosTrabalho.cidadeEstado);
