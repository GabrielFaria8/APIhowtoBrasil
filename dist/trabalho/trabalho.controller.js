...
let TrabalhoController = class TrabalhoController {
    ...
    async criaTrabalho(dadosTrabalho) {
        var trabalho = new trabalho_entity_1.TrabalhoEntity((0, uuid_1.v4)(), dadosTrabalho.tipos, dadosTrabalho.nome, dadosTrabalho.trabalho, dadosTrabalho.preRequisitos, dadosTrabalho.siteEmpresa, dadosTrabalho.salario, dadosTrabalho.descricao, dadosTrabalho.foto);
